...
import { Layers, Package, TrendingUp, Target } from "lucide-react";
...
export default function MetaStickyNav() {
  const [activeId, setActiveId] = useState<string>("sistem");
