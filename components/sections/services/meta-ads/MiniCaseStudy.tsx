...
export default function MiniCaseStudy() {
  return (
    <section className="relative py-24 md:py-32 overflow-hidden border-t border-white/5 bg-brand-dark">
      {/* Dekoratif arka plan */}
          ...
          <div className="lg:col-span-6">
            <ScrollReveal>
              ...
              <h3 className="text-xl font-bold mb-4 text-brand-blue">
                Estetik Klinik — Instagram Lead Kampanyası
              </h3>
              <p className="text-gray-400 text-lg leading-relaxed mb-10">
                Sağlık sektöründe Instagram Leads kampanyası, CAPI kurulumu ve
                kreatif rotasyonu ile{" "}
                <strong className="text-white">90 günde ROAS 4.6x&apos;e</strong>{" "}
                çıktı. Kayıp veri sorunu çözüldü, algoritma doğru sinyalleri
                almaya başladı.
              </p>
              ...
              <div className="space-y-6">
                {[
                  {
                    title: "CAPI Kurulumu",
                    desc: "Kayıp veriyi geri kazandı — %40 eksik dönüşüm verisi düzeldi.",
                  },
                  {
                    title: "Kreatif A/B Test",
                    desc: "Before/after format en yüksek CTR'yi sağladı.",
                  },
                  {
                    title: "WhatsApp Click-to-Chat",
                    desc: "Doğrudan mesajlaşma ile lead maliyeti %62 düştü.",
                  },
                ].map((item, idx) => (
