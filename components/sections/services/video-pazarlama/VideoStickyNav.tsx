...
import { Play, Workflow, Building2, Lightbulb } from "lucide-react";
...
export default function VideoStickyNav() {
  const [activeId, setActiveId] = useState<string>("format");
