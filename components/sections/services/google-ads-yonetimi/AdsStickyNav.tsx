...
import { ShieldAlert, Zap, BarChart3, Target } from "lucide-react";
...
export default function AdsStickyNav() {
  const [activeId, setActiveId] = useState<string>("teshis");
