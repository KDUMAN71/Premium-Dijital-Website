...
import ServiceHeroRadar from "./ServiceHeroRadar";
...
export default function ServicePageTemplate({
  ...
  return (
    <main className="bg-brand-dark text-white">
      {/* HERO */}
      <section className="relative mx-auto max-w-7xl overflow-hidden px-4 py-16 sm:px-5 sm:py-20 md:px-6 md:py-28">
        {" "}
        <ServiceHeroRadar />
