...
const pageUrl =
  "https://premiumdijital.com/hizmetler/ppc-ve-performans-pazarlama";
    ...
    <>
      ...
      >
        ...
        >
          ...
          <div className="grid grid-cols-1 gap-px overflow-hidden rounded-[2rem] border border-white/10 bg-white/10">
            {serviceScope.map((item, index) => (
              <div
                key={item.title}
                className="group relative bg-brand-dark px-5 py-6 transition-all duration-300 hover:bg-white/[0.03] sm:px-6 sm:py-7 md:px-8 md:py-8"
              >
                {/* üstten hafif ışık sızması */}
            ...
            <div className="mb-14 grid gap-10 lg:grid-cols-2 lg:items-center">
              <div>
                ...
                <p className="mt-4 max-w-xl text-sm leading-relaxed text-gray-400">
                  Doğru veri olmadan reklam optimizasyonu yapılamaz. Bu nedenle
                  ölçüm altyapısı, conversion tracking ve raporlama sistemlerini
                  reklam yönetimi ile birlikte tasarlıyoruz.
                </p>
              </div>

              {/* SYSTEM PANEL */}
              <div className="relative rounded-[2rem] border border-white/10 bg-black/40 p-8 backdrop-blur-xl">
                {/* glow */}
                ...
                <div className="relative grid gap-4 sm:grid-cols-2">
                  {techStack.map((item) => (
                    <div
                      key={item.name}
                      className="group rounded-xl border border-white/10 bg-white/5 p-5 transition-all duration-300 hover:-translate-y-[2px] hover:border-brand-blue/30 hover:bg-white/[0.08]"
                    >
          ...
          <div className="mx-auto max-w-6xl px-4 py-20 sm:px-5 md:px-6">
            <div className="mb-14 text-center">
              ...
              <p className="mx-auto mt-4 max-w-3xl text-sm leading-relaxed text-gray-300 sm:text-base">
                Planlama, kurulum, optimizasyon ve ölçekleme adımlarından oluşan
                sistemli bir reklam yönetim modeli ile ilerliyoruz.
              </p>
            </div>
            ...
            <div className="relative">
              ...
              <div className="space-y-6 md:space-y-8">
                {growthMethod.map((step) => (
                  <div
                    key={step.title}
                    className="group relative grid grid-cols-1 gap-4 rounded-[2rem] border border-white/10 bg-white/5 p-5 backdrop-blur-xl transition-all duration-300 hover:-translate-y-0.5 hover:border-brand-blue/25 hover:bg-white/[0.06] hover:shadow-[0_0_30px_rgba(0,0,200,0.10)] md:grid-cols-[72px_minmax(0,1fr)] md:gap-6 md:p-8"
                  >
                    {/* sol kolon */}
        ...
        >
          <div className="mx-auto max-w-7xl px-4 py-20 sm:px-5 md:px-6 md:py-24">
            <div className="mb-14 text-center">
              ...
              <p className="mx-auto mt-4 max-w-3xl text-sm leading-relaxed text-gray-300 sm:text-base">
                Performans pazarlamanın amacı yalnızca reklam yayınlamak değil,
                işletmeniz için ölçülebilir büyüme üretmektir.
              </p>
            </div>

            <div className="grid grid-cols-1 gap-px overflow-hidden rounded-[2rem] border border-white/10 bg-white/10 md:grid-cols-2 xl:grid-cols-4">
              {resultMetrics.map((item, index) => (
                <div
                  key={item.title}
                  className="group relative bg-brand-dark px-6 py-8 transition-all duration-300 hover:bg-white/[0.03] hover:shadow-[0_0_40px_rgba(0,80,255,0.15)]"
                >
                  {/* üst ışık sızması */}
                  ...
                  <div className="relative z-10">
                    <div className="flex items-start justify-between">
                      ...
                      <div className="flex h-10 w-10 items-center justify-center rounded-xl border border-white/10 bg-white/5 text-brand-blue transition-all duration-300 group-hover:border-brand-blue/30 group-hover:bg-brand-blue/10 group-hover:text-white">
                        {item.icon}
                      </div>
                    </div>

                    <div className="relative mt-6 text-3xl font-bold italic tracking-tight text-white/90 sm:text-4xl md:text-5xl whitespace-nowrap">
                      <span className="relative z-10">{item.metric}</span>

                      <span className="absolute inset-0 blur-2xl opacity-0 transition-opacity duration-300 group-hover:opacity-30 bg-brand-blue/20" />
                    </div>
          ...
          <div className="mx-auto max-w-6xl px-4 py-16 sm:px-5 sm:py-20 md:px-6 md:py-24">
            ...
            <div className="mt-10 grid gap-6 md:grid-cols-2">
              {audienceFit.map((item) => (
                <div
                  key={item.title}
                  className="group rounded-2xl border border-white/10 bg-white/5 p-6 backdrop-blur-xl transition-all duration-300 hover:-translate-y-1 hover:border-brand-blue/25 hover:bg-white/[0.07] hover:shadow-[0_0_30px_rgba(0,0,200,0.12)]"
                >
          ...
          <div className="mx-auto max-w-4xl px-4 py-16 sm:px-5 sm:py-20 md:px-6 md:py-24">
            ...
            <div className="mt-10 space-y-4">
              {ppcFaqs.map((item) => (
                <details
                  key={item.q}
                  className="group rounded-2xl border border-white/10 bg-white/5 p-2 backdrop-blur-xl transition-all duration-300 hover:border-brand-blue/20 hover:bg-white/[0.08] open:border-brand-blue/25 open:bg-white/[0.07] open:shadow-[0_0_30px_rgba(0,0,200,0.10)]"
                >
